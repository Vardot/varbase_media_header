Feature: The Varbase Media Header block is provided
  ...
  # the Varbase front-end theme (vartheme_bs4).

  Background:
    Given I am a logged in user with the "Webmaster" user

  Scenario: The Varbase Media Header block appears in the vartheme_bs4 block library
    When I open the administration page "/admin/structure/block/library/vartheme_bs4"
  ...
  Scenario: The Varbase Media Header block configuration form offers the media view mode
    When I open the administration page "/admin/structure/block/add/varbase_media_header_block/vartheme_bs4"
